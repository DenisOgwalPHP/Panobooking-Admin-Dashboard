...
<head>
  ...
  <title>PANOBOOKING | Registered Users Records</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="registeredusers.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Registered Users Records</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sales7 = "SELECT * FROM `registration` where Email='$singleuser' order by IDDesc Desc";
                      ...
                      while ($row7 = mysqli_fetch_assoc($result7)) {
                        ...
                        echo  "<td style='overflow-x:scroll;'>" . $row7['Telephone'] . "</td>";
                        echo  "<td style='overflow-x:scroll;'>" . $row7['Address'] . "</td>";
                        ...
                        echo  "<td><form method='get' action='registeredusers.php'><button type='submit' name='delete'  value='" . $id . "' class='btn btn-block btn-danger'>Delete</button></form></td>";
                        echo " </tr>";
                        $counter3++;
                      }
					   }else{
						$dates = date("Y-m-d");
                      require_once('../../connect/connect.php');
                      $sales7 = "SELECT * FROM `registration` order by IDDesc Desc";
                      $result7 = mysqli_query($link, $sales7);
                      $counter3 = 1;
                      $totalstock = 0;
                    ...
                    if (isset($_GET['delete'])) {
                      $id = $_GET['delete'];
                      $sales7 = "DELETE  FROM registration WHERE IDDesc='" . $id . "'";
                      $result = mysqli_query($link, $sales7);
                      if ($result) {
                        echo '<script type="application/javascript">';
                        echo 'alert("Client Record successfully Deleted");';
                        echo 'window.location.href="registeredusers.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
                        echo 'alert("Client Record Delete Failed");';
                        echo 'window.location.href="registeredusers.php";';
                        echo '</script>';
                      }
                    }
