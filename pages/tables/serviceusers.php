...
<head>
  ...
  <title>PANOBOOKING | Registered Service Provider Logins</title>
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
				 ...
				 <li class="nav-item">
                  <a href="pages/tables/serviceusers.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Registered Service Providers Logins</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../DashBoard.php">Home</a></li>
                <li class="breadcrumb-item active">Registered Service Providers Logins</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Registered Service Providers Logins Records</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sales7 = "SELECT * FROM `accomodationregistration` order by IDDesc Desc";
                      ...
                      while ($row7 = mysqli_fetch_assoc($result7)) {
                        ...
                        $id = $row7['IDDesc'];
                        echo  "<td>" . $counter3 . "</td>";
                        echo  "<td style='overflow-x:scroll;'>" . $row7['created_at'] . "</a></td>";
                        echo  "<td style='overflow-x:scroll;'>" . $row7['FullNames'] . "</td>";
                        echo  "<td style='overflow-x:scroll;'>" . $row7['Email'] . "</td>";
						 echo  "<td style='overflow-x:scroll;'>" . $row7['Place'] . "</td>";
                        $approvals = $row7['ApprovalStatus'];
                        if ($approvals == 'Approved') {
                          echo  "<td style='overflow-x:scroll;'>" . $row7['ApprovalStatus'] . "</td>";
                        } else {
                        ...
                        echo  "<td><form method='get' action='serviceusers.php'><button type='submit' name='delete'  value='" . $id . "' class='btn btn-block btn-danger'>Delete</button></form></td>";
                        echo " </tr>";
                        $counter3++;
                      }
                      ?>
                    ...
                    if (isset($_GET['delete'])) {
                      $id = $_GET['delete'];
                      $sales7 = "DELETE  FROM accomodationregistration WHERE IDDesc='" . $id . "'";
                      $result = mysqli_query($link, $sales7);
                      if ($result) {
                        echo '<script type="application/javascript">';
                        echo 'alert("User Record successfully Deleted");';
                        echo 'window.location.href="serviceusers.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
                        echo 'alert("User Record Delete Failed");';
                        echo 'window.location.href="serviceusers.php";';
                        echo '</script>';
                      }
                    }
                    ?> <?php
                        if (isset($_GET['approve'])) {
                          $id = $_GET['approve'];
                          if (isset($id)) {
                            $sales6 = "UPDATE accomodationregistration SET ApprovalStatus='Approved' WHERE IDDesc='" . $id . "'";
                            $result = mysqli_query($link, $sales6);
                            if ($result) {
                              echo '<script type="application/javascript">';
                              echo 'alert("User Approval Successful");';
                              echo 'window.location.href="serviceusers.php";';
                              echo '</script>';
                            } else {
                              echo '<script type="application/javascript">';
                              echo 'alert("User Approval Failed");';
                              echo 'window.location.href="serviceusers.php";';
                              echo '</script>';
                            }
                          }
