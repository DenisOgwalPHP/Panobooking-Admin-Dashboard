...
<head>
  ...
  <title>PANOBOOKING | Travel Articles Records</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="travelarticles.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>TravelArticles</p>
                  </a>
                </li>
                ...
                <li class="nav-item">
				 ...
				 <li class="nav-item">
                  <a href="serviceusers.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Travel Articles</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Travel Articles Records</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sales7 = "SELECT * FROM `travelarticles` order by IDs Desc";
                      ...
                      while ($row7 = mysqli_fetch_assoc($result7)) {
                        ...
                        $id = $row7['IDs'];
                        echo  "<td>" . $counter3 . "</td>";
                        echo  "<td style='overflow-x:scroll;'>" . $row7['PostedAt'] . "</a></td>";
                        echo  "<td style='overflow-x:scroll;'>" . $row7['ArticleTitle'] . "</td>";
                        echo  "<td style='overflow-x:scroll;'>" . $row7['Details'] . "</td>";
                        echo  "<td style='overflow-x:scroll;'>" . $row7['PostedBy'] . "</td>";
                        echo  "<td><form method='get' action='travelarticles.php'><button type='submit' name='delete'  value='" . $id . "' class='btn btn-block btn-danger'>Delete</button></form></td>";
                        echo " </tr>";
                        $counter3++;
                      }
                      ?>
                    ...
                    if (isset($_GET['delete'])) {
                      $id = $_GET['delete'];
                      $sales7 = "DELETE  FROM travelarticles WHERE IDs='" . $id . "'";
                      $result = mysqli_query($link, $sales7);
                      if ($result) {
                        echo '<script type="application/javascript">';
                        echo 'alert("Travel Article Record successfully Deleted");';
                        echo 'window.location.href="travelarticles.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
                        echo 'alert("Travel Article Record Delete Failed");';
                        echo 'window.location.href="travelarticles.php";';
                        echo '</script>';
                      }
                    }
