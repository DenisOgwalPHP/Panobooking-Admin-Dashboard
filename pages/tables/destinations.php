...
<head>
  ...
  <title>PANOBOOKING | Destination Records</title>
...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="destinations.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
			  ...
			  <li class="nav-item">
                <a href="taxis.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
			  ...
			  <li class="nav-item">
                <a href="guesthouses.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Home Guest Houses</p>
                </a>
              </li>
			  ...
			  <li class="nav-item">
                <a href="tourismarticles.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tourism Articles</p>
                </a>
              </li>
			  <li class="nav-item">
                <a href="travelarticles.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>TravelArticles</p>
                </a>
              </li>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Destination Records</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
					...
					<th>Least Prices</th>
					<th>Price Specification</th>
					<th>Taxes Inclusive</th>
					<th>Payment Options</th>
					<th>Bed & Breakfast Inclusive</th>
                  ...
                  <?php
				   if(isset($_GET['places'])){
						...
						$sales7 ="SELECT * FROM `pickuplocations` where Place='$places' order by IDs Desc";
						...
						while($row7=mysqli_fetch_assoc($result7)){ 
										   ...
										   echo  "<td style='overflow-x:scroll;'>".$row7['PriceSpecifications']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['TaxesInclusive']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['Prepayment']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['BedBreakFast']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['CreditCard']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['ExactLocation']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['coordinates']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['Facilities']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['SustainabilityInitiatives']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['Policies']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['Checkout']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['Transportation']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['TransportAir']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['TransportPark']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['Market']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['SuperMarket']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['CafeandBar']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['Restaurant']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['Description']."</td>";
										   echo  "<td><form method='get'><button type='submit' name='delete'  value='".$id."' class='btn btn-block btn-danger'>Delete</button></form></td>";
										   echo  "<td><form method='get' action='destinationdetails.php'><input type='hidden' class='form-control' name='detailsplace' value='".$roomname."'><button type='submit' name='moredetails'  value='".$id."' class='btn btn-block btn-warning'>Add Details</button></form></td>";
										   echo  "<td><form method='get' action='addroom.php'><button type='submit' name='addroom'  value='".$roomname."' class='btn btn-block btn-success'>Add Room</button></form></td>";
										  echo  "<td style='overflow-x:scroll;'>".$row7['FaturedRank']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['TrendRank']."</td>";
										   echo  "<td><form method='get' action='addroom.php'><button type='submit' name='addroom'  value='".$roomname."' class='btn btn-block btn-success'>Add Room</button></form></td>";
										   echo  "<td><form method='get' action='addroom.php'><button type='submit' name='addroom'  value='".$roomname."' class='btn btn-block btn-success'>Add Room</button></form></td>";
										   echo" </tr>" ;
										   $counter3++;
				  ...
				  else if(isset($_GET['adddetails'])){
					    $dates=date("Y-m-d");
						$placeaddition=$_GET['adddetails'];
						require_once('../../connect/connect.php');
						$sales7 ="SELECT * FROM `pickuplocations` where City='$placeaddition' order by IDs Desc";
						$result7=mysqli_query($link,$sales7);
						$counter3=1;
						$totalstock=0;
						while($row7=mysqli_fetch_assoc($result7)){ 
					  	...
					  	$dates=date("Y-m-d");
						require_once('../../connect/connect.php');
						$sales7 ="SELECT * FROM `pickuplocations` order by IDs Desc";
						$result7=mysqli_query($link,$sales7);
						$counter3=1;
						$totalstock=0;
						...
						while($row7=mysqli_fetch_assoc($result7)){ 
										  ...
										  echo  "<td style='overflow-x:scroll;'>".$row7['FaturedRank']."</td>";
										   echo  "<td style='overflow-x:scroll;'>".$row7['TrendRank']."</td>";
										   echo  "<td><button type='button'  class='btn btn-success' data-toggle='modal' data-target='#modal-success'>Add Feature</button>";
										   echo  "<td><button type='button'  class='btn btn-primary' data-toggle='modal' data-target='#modal-primary'>Add Trend</button>";
										   echo" </tr>" ;
										   $counter3++;
						}
				  }
  ...
  -->
				...
				$id=$_GET['delete'];	
				$sales6 ="DELETE  FROM pickuplocations WHERE IDs='".$id."'";
				$result=mysqli_query($link,$sales6);
				if($result){
				echo '<script type="application/javascript">';
				echo'alert("Destinations Record successfully Deleted");';
				echo'window.location.href="destinations.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
				echo'alert("Destinations Record Delete Failed");';
				echo'window.location.href="destinations.php";';
				echo '</script>';
						 }
						 }
  ...
  <div class="modal fade" id="modal-primary">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            <div class="modal-header">
              <h4 class="modal-title">Add Trend Rank</h4>
            ...
            <div class="modal-body">
			 ...
			 <div class="input-group">
					<div class="custom-file">
					 <input type="number" class="form-control" id="realvalue" placeholder="Add Rank" name="realvalue" required>
					</div>
            </div>
			<p>&nbsp;</p>
			<div class="input-group">
			   <button type="submit" name="trendupdate" class="btn btn-danger">Update Trend</button>
			</div>
            </div>
			</form>
	   ...
	   <?php
		  if (isset($_REQUEST['trendupdate'])) {
			  $place = $_POST['Place'];	
			$realvalue = $_POST['realvalue'];	
			require_once('../../connect/connect.php');
			$query = "UPDATE `pickuplocations` SET Trending='Yes',TrendRank='".$realvalue."' WHERE Place='".$place."'";
  ...
  <div class="modal fade" id="modal-success">
        <div class="modal-dialog">
          <div class="modal-content bg-success">
            <div class="modal-header">
              <h4 class="modal-title">Add Feature Rank</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
           <form action="destinations.php" method="post" >
			...
			<p>&nbsp;</p>
			<div class="input-group">
			   <button type="submit" name="featureupdate" class="btn btn-danger">Update Feature</button>
			</div>
            </div>
			</form>
            <div class="modal-footer justify-content-between">
	   ...
	   <?php
		  if (isset($_REQUEST['featureupdate'])) {
			  $place = $_POST['Place'];	
			$realvalue = $_POST['realvalue'];	
			require_once('../../connect/connect.php');
			$query = "UPDATE `pickuplocations` SET Featured='Yes',FaturedRank='".$realvalue."' WHERE Place='".$place."'";
			$result4=mysqli_query($link,$query);
			if($result4){
			echo '<script type="application/javascript">';
			echo'alert("Update Done");';
