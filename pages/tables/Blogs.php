...
<head>
  ...
  <title>PANOBOOKING | Blog Records</title>
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Blogs Records</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sales7 = "SELECT * FROM `blogs` order by ID Desc";
                      ...
                      while ($row7 = mysqli_fetch_assoc($result7)) {
                        ...
                        $id = $row7['ID'];
                        echo  "<td>" . $counter3 . "</td>";
                        echo  "<td style='overflow-x:scroll;'>" . $row7['Date'] . "</a></td>";
                        echo  "<td style='overflow-x:scroll;'>" . $row7['BlogTitle'] . "</td>";
						echo  "<td style='overflow-x:scroll;'>" . $row7['BlogShortDescription'] . "</td>";
                        echo  "<td style='overflow-x:scroll;'>" . $row7['Description'] . "</td>";
                        echo  "<td style='overflow-x:scroll;'>" . $row7['PostedBy'] . "</td>";
						$approve = $row7['Approved'];
						if($approve=="Not Approved"){
						  echo  "<td><form method='get' action='Blogs.php'><button type='submit' name='approve'  value='" . $id . "' class='btn btn-block btn-success'>Approve</button></form></td>";	
						}else{
							 echo  "<td style='overflow-x:scroll;'>" . $row7['Approved'] . "</td>";
						}
                        echo  "<td><form method='get' action='Blogs.php'><button type='submit' name='delete'  value='" . $id . "' class='btn btn-block btn-danger'>Delete</button></form></td>";
                        echo " </tr>";
                        $counter3++;
                      }
                      ?>
                    ...
                    if (isset($_GET['delete'])) {
                      $id = $_GET['delete'];
                      $sales7 = "DELETE  FROM blogs WHERE ID='" . $id . "'";
                      $result = mysqli_query($link, $sales7);
                      if ($result) {
                        echo '<script type="application/javascript">';
                        echo 'alert("Blog Record successfully Deleted");';
                        echo 'window.location.href="Blogs.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
                        echo 'alert("Blog Record Delete Failed");';
                        echo 'window.location.href="Blogs.php";';
                        echo '</script>';
                      }
                    }
					 ...
					 if (isset($_GET['approve'])) {
                      $id = $_GET['approve'];
                      $sales7 = "UPDATE  blogs Set Approved='Approved' WHERE ID='" . $id . "'";
                      $result = mysqli_query($link, $sales7);
                      if ($result) {
                        echo '<script type="application/javascript">';
                        echo 'alert("Blog Record successfully Approved");';
                        echo 'window.location.href="Blogs.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
                        echo 'alert("Blog Approval Failed");';
                        echo 'window.location.href="Blogs.php";';
                        echo '</script>';
                      }
                    }
