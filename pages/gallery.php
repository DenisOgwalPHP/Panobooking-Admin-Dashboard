...
<head>
  ...
  <title>PANOBOOKING | Gallery</title>
            ...
            <div class="col-12">
              <div class="card card-primary">
                <div class="card-header">
                  <h4 class="card-title">View your Default Gallery</h4>
                </div>
                <div class="card-body">
                  <div>
                    <div class="btn-group w-100 mb-2">
                      <a class="btn btn-info active" href="javascript:void(0)" data-filter="0"> Accomodation </a>
                      <a class="btn btn-info" href="javascript:void(1)" data-filter="1"> Rooms</a>
                      <a class="btn btn-info" href="javascript:void(2)" data-filter="2"> Taxis</a>
                      <a class="btn btn-info" href="javascript:void(2)" data-filter="2"> Rental Cars</a>
                      <a class="btn btn-info" href="javascript:void(2)" data-filter="2"> Ambulances</a>
                    </div>
                    <div class="mb-2">
                  ...
                  <div>
					<?php 
						$dir = '../../AndroidFiles/DestinationImages/';
						$fi = new FilesystemIterator($dir, FilesystemIterator::SKIP_DOTS);
						  echo'<div class="filter-container p-0 row">';
						  $images = glob($dir."*.jpg");
						  foreach($images as $image) {
						  //for($i=0;$i<iterator_count($fi);$i++){
                       echo'<div class="filtr-item col-sm-2" data-category="0" data-sort="white sample">';
                         echo'<a href="'.$dir.$image.'" data-toggle="lightbox" data-title="'.basename($image).'">';
                           echo'<img src="'.$dir.$image.'" class="img-fluid mb-5" alt="'.basename($image).'" />';
                         echo'</a>';
                      echo'</div>';
						  //}
						  }
					  ...
					  ?>
					  <?php 
						$dir = '../../AndroidFiles/RoomImages/';
						$fi = new FilesystemIterator($dir, FilesystemIterator::SKIP_DOTS);
						  echo'<div class="filter-container p-0 row">';
						  $images = glob($dir."*.jpg");
						  foreach($images as $image) {
						  //for($i=0;$i<iterator_count($fi);$i++){
                       echo'<div class="filtr-item col-sm-2" data-category="1" data-sort="white sample">';
                         echo'<a href="'.$dir.$image.'" data-toggle="lightbox" data-title="'.basename($image).'">';
                           echo'<img src="'.$dir.$image.'" class="img-fluid mb-5" alt="'.basename($image).'" />';
                         echo'</a>';
                      echo'</div>';
					...
					?>
					  <?php 
						$dir = '../../AndroidFiles/AndroidDriver/FileUpload/';
						$fi = new FilesystemIterator($dir, FilesystemIterator::SKIP_DOTS);
						  echo'<div class="filter-container p-0 row">';
						  $images = glob($dir."*.jpg");
						  foreach($images as $image) {
						  //for($i=0;$i<iterator_count($fi);$i++){
                       echo'<div class="filtr-item col-sm-2" data-category="2" data-sort="white sample">';
                         echo'<a href="'.$dir.$image.'" data-toggle="lightbox" data-title="'.basename($image).'">';
                           echo'<img src="'.$dir.$image.'" class="img-fluid mb-5" alt="'.basename($image).'" />';
                         echo'</a>';
                      echo'</div>';
