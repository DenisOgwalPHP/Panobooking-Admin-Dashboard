...
<head>
  ...
  <title>PANOBOOKING | Travel Articles</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="AddTravelArticles.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Travel Articles Form</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../DashBoard.php">Home</a></li>
                <li class="breadcrumb-item active">Travel Articles Form</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Add Travel Article</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="../formsinsert/inserttravelarticles.php" enctype="multipart/form-data">
                  <div class="card-body">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-danger">
                <div class="card-header">
                  <h3 class="card-title">Travel Articles</h3>
                </div>
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sales7 = "SELECT * FROM `travelarticles` order by IDs Desc LIMIT 30";
                    ...
                    <tfoot>
                      <tr>
                        <th>X</th>
                        <th> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-primary">Add Travel Article Image</button></th>
    ...
    <!-- /.content-wrapper -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-warning">
           ...
           <form action="AddTravelArticles.php" method="post" enctype="multipart/form-data">
            <div class="modal-body">
			<select class="form-control" id="Place" name="Place" required>
                        <?php require_once('../../connect/connect.php');
						$sales9 ="SELECT Distinct ArticleTitle FROM `travelarticles`";
      ...
      <!-- /.modal -->
	   <?php
		  if (isset($_REQUEST['savearticle'])=="Updatearticle") {
			...
			echo'window.location.href="AddTravelArticles.php";';
			echo '</script>';
		  }
      ...
      <div class="modal fade" id="modal-danger">
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
           ...
           <form action="../formsinsert/updatetravelarticledetails.php" method="post">
		    <div class="modal-body">
        <p>&nbsp;</p>
      ...
      <div class="modal fade" id="modal-primary">
        <div class="modal-dialog">
		  ...
		  if (isset($_REQUEST['saveimage'])) {
			...
			$target = '../../../AndroidFiles/TravelArticleThumbNail/';
			$fileTarget = $target . $newfilename;
			$tempFileName = $_FILES["Filename"]["tmp_name"];
			$result = move_uploaded_file($tempFileName, $fileTarget);
			echo '<script type="application/javascript">';
			echo'alert("Upload of Travel Article Thumbnail Done");';
			echo'window.location.href="AddTravelArticles.php";';
			echo '</script>';
		  }
		  ?>
