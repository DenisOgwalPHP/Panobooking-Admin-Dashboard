...
<head>
  ...
  <title>PANOBOOKING | New Tour Package Requests</title>
          ...
          <a class="nav-link" data-toggle="dropdown" href="#">
           ...
           <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="NewHomeguestHouseRegistration.php" class="dropdown-item">
              <i class="fas fa-home mr-2"></i> <?php require('../../includes/AllnewHomeguesthouseRegistration.php') ?> new Tour Package Requests
              <!--<span class="float-right text-muted text-sm">2 days</span>-->
            </a>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
				...
				<li class="nav-item">
                  ...
                  <li class='nav-item'>
                  <a href='NewHomeguestHouseRequests.php' class='nav-link active'>
                  <i class='far fa-circle nav-icon'></i>
                  <p>Tour Packages</p>
                  </a>
                  </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>New Tour Package Request</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../DashBoard.php">Home</a></li>
                <li class="breadcrumb-item active">New Tour Package Request List</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card" style='overflow:auto'>
                <div class="card-header">
                  <h3 class="card-title">New Tour Package Request List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                        ...
                        $sales7 = "SELECT * FROM `cart` where Status='New' and BookingType='Tour Package' order by IDs Desc";
						 ...
						 echo "<div class='modal-dialog'>";
						   echo "<div class='modal-content bg-success'>";
							 echo "<div class='modal-header'>";
							   ...
							   echo "</button>";
							 echo "</div>";
							 echo "<form action='NewHomeguestHouseRequests.php' method='post'>";
                    ...
                    if (isset($_GET['changestatus'])) {
                      ...
                      if ($result11) {
                        ...
                        echo 'window.location.href="NewHomeguestHouseRequests.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
