...
<head>
  ...
  <title>PANOBOOKING | New Blog Comments</title>
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
				...
				<li class="nav-item">
				 ...
				 <li class="nav-item">
                   <a href='NewBlogComments.php' class='nav-link active'>
                  <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>New Blog Comments</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../DashBoard.php">Home</a></li>
                <li class="breadcrumb-item active">New Blog Comments List</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card" style='overflow:auto'>
                <div class="card-header">
                  <h3 class="card-title">New Blog Comments List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                        ...
                        $sales7 = "SELECT * FROM `blogcomments`,`blogs` where Status='New' and blog_model_id=ID order by  CommentID Desc";
                        ...
                        while ($row7 = mysqli_fetch_assoc($result7)) {
                          ...
                          echo  "<td style='overflow-x:scroll;'>" . $row7['NameOfCommenter'] . "</td>";
                          echo  "<td style='overflow-x:scroll;'>" . $row7['CommentEmail'] . "</td>";
						   echo  "<td style='overflow-x:scroll;'>" . $row7['Comment'] . "</td>";

						  if($row7['Approval']=="Not Approved"){
							 echo  "<td><form method='get' action='NewBlogComments.php'><button type='submit' name='changeapproval'  value='" . $id . "' class='btn btn-block btn-danger'>Approve</button></form></td>";  
						  }else{
							 echo  "<td style='overflow-x:scroll;'>" . $row7['Approval'] . "</td>";  
						  }
						  if($row7['Status']=="New"){
							 echo  "<td><form method='get' action='NewBlogComments.php'><button type='submit' name='changestatus'  value='" . $id . "' class='btn btn-block btn-danger'>New</button></form></td>";  
						  }else{
                    ...
                    if (isset($_GET['changestatus'])) {
					  ...
					  $sales11 = "UPDATE  blogcomments SET Status='Opened'  WHERE CommentID='$id'";
                      $result11 = mysqli_query($link, $sales11);
                      if ($result11) {
                        echo '<script type="application/javascript">';
                        echo 'alert("Status Updated");';
                        echo 'window.location.href="NewBlogComments.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
                     ...
                     if (isset($_GET['changeapproval'])) {
                      $id = $_GET['changeapproval'];
					  $sales11 = "UPDATE  blogcomments SET Approval='Approved'  WHERE CommentID='$id'";
                      $result11 = mysqli_query($link, $sales11);
                      if ($result11) {
                        echo '<script type="application/javascript">';
                        echo 'alert("Status Updated");';
