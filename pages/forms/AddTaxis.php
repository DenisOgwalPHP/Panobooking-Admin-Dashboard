...
<head>
  ...
  <title>PANOBOOKING | Airport Taxi</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="AddTaxis.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Airport Taxis Form</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../DashBoard.php">Home</a></li>
                <li class="breadcrumb-item active">Airport Taxis Form</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Add Airport Taxi</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="../formsinsert/inserttaxis.php" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Taxi Reg. No./CarName</label>
                      <input type="text" class="form-control" id="carregno" name="carregno" placeholder="Enter Taxi Reg. No" required>
                    </div>
					  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Taxi Specifications</label>
                      <input type="text" class="form-control" id="carspec" name="carspec" placeholder="Enter Taxi Specifications e.g (Model)" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Ratings</label>
                      <input type="text" class="form-control" id="ratings" name="ratings" placeholder="Rate this Taxi" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Driver Name/Company</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="address" name="address" placeholder="Enter Parking Address of Taxi" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleInputFile">Taxi Photo</label>
                  ...
                  <div class="card-footer">
					...
					<th><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-category">Category Images</button></th>
					 <th><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-otherdetails">Other Taxi Details</button></th>
                  </div>
                </form>
              </div>
              <!-- /.card -->
            </div>
		<div class="modal fade" id="modal-otherdetails">
        <div class="modal-dialog modal-lg">
          <div class="modal-content bg-success">
			...
			<select class="form-control" id="CompanyName" name="CompanyName" onchange="loadcars(this.value)" required>
						...
						$sales9 ="SELECT Distinct DriverName FROM `airporttaxi`";
						$result9=mysqli_query($link,$sales9);
						echo '<option value="">Select Company/Driver</option>';
	   ...
	   <Script type="text/javascript">
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-warning">
            <div class="modal-header">
              <h4 class="modal-title">Add Taxi Car Category Image</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
		  ...
		  ?>
            ...
            <div class="col-md-6">
              ...
              <div class="card card-danger">
                <div class="card-header">
                  <h3 class="card-title">Most Recently Registered Taxis</h3>
                </div>
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $dates = date("Y-m-d");;
                      require_once('../../connect/connect.php');
                      $sales7 = "SELECT * FROM `airporttaxi` order by IDs Desc LIMIT 50";
                    ...
                    <tfoot>
                       <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-success">Taxi Image</button>
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-primary">Edit Taxi Details</button>
	...
	<div class="modal fade" id="modal-search">
        <div class="modal-dialog">
          <div class="modal-content bg-info">
           ...
           <form action="AddTaxis.php" method="post" >
            <div class="modal-body">
			<div class="input-group">
			<div class="custom-file">
      ...
      <!-- /.modal -->
		 <?php
		  if (isset($_REQUEST['savesearchterm'])) {
			...
			$query = "UPDATE `airporttaxi` SET SearchTerms='".$realvalue."' WHERE TaxiNo='".$place."'";
			$result4=mysqli_query($link,$query);
			
			if($result4){
			echo '<script type="application/javascript">';
			echo'alert("Addition Done");';
			echo'window.location.href="AddTaxis.php";';
			echo '</script>';
			}else{
			echo '<script type="application/javascript">';
	  ...
	  <?php
		   ...
		   if (isset($_REQUEST['savetrip'] )=="savetri") {
			...
			require_once('../../connect/connect.php');
			$sql="INSERT INTO `taxitrip` (Froms,Tos,Price) VALUES('$froms','$tos','$cost')";
			mysqli_query($link,$sql);
			echo '<script type="application/javascript">';
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-success">
            <div class="modal-header">
              <h4 class="modal-title">Add Taxi Image</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="AddTaxis.php" method="post" enctype="multipart/form-data">
            <div class="modal-body">
			<select class="form-control" id="Place" name="Place" required>
                        <?php require_once('../../connect/connect.php');
						$sales9 ="SELECT Distinct TaxiNo FROM `airporttaxi`";
			...
			<div class="custom-file">
			  <input type="file" class="custom-file-input" id="Filenames" name="Filenames">
			  <label class="custom-file-label" for="exampleInputFile">Taxi Image(Dimensions should be 850x850 pixels)</label>
			</div>
			 </div>
			 <p>&nbsp;</p>
			 <div class="input-group">
      ...
      <!-- /.modal -->
	   <?php
		  if (isset($_REQUEST['updateplaceimages'])=="updateima") {
			...
			$result = move_uploaded_file($tempFileName, $fileTarget);
			echo '<script type="application/javascript">';
			echo'alert("Update of Taxi Image Done");';
			echo'window.location.href="AddTaxis.php";';
			echo '</script>';
		  }
		   ...
		   if (isset($_REQUEST['saveplaceimages'] )=="updateima") {
			$place = $_POST['Place'];
			require_once('../../connect/connect.php');
			$sql1="SELECT PhotoUri FROM airporttaxi where TaxiNo like '".$place."%'";
			$result1=mysqli_query($link,$sql1);
			if (mysqli_num_rows($result1) == 1)
			{
			$row = mysqli_fetch_array($result1);
			$imageurl=$row['PhotoUri']+1;
			$sql="UPDATE airporttaxi SET PhotoUri='$imageurl' where TaxiNo like '".$place."%'";
			mysqli_query($link,$sql);
			}
			$fileName = $_FILES['Filenames']['name'];
			$temp = explode(".", $_FILES["Filenames"]["name"]);
	  ...
	  <div class="modal fade" id="modal-primary">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            <div class="modal-header">
              <h4 class="modal-title">Update Taxi Details</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
         <form action="../formsinsert/updateairporttaxidetails.php" method="post">
		  <div class="modal-body">
        <p>&nbsp;</p>
		<div class="input-group">
          <div class="custom-file">
        <select class="form-control" id="taxi" name="taxi" required>
          ...
          $sales9 = "SELECT Distinct TaxiNo FROM `airporttaxi`";
          $result9 = mysqli_query($link, $sales9);
          echo '<option value="Other">Select Taxi</option>';
          while ($row9 = mysqli_fetch_assoc($result9)) {
            echo '<option value="' . $row9['TaxiNo'] . '">' . $row9['TaxiNo'] . '</option>';
          }  ?>
        </select>
