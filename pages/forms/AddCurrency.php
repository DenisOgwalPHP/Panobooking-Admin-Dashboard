...
<head>
  ...
  <title>PANOBOOKING | Currency</title>
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
				...
				<li class="nav-item">
				 ...
				 <li class="nav-item">
                  <a href="AddCurrency.php" class="nav-link  active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Edit Currency</p>
                  </a>
                </li>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Edit Currency Form</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="../formsinsert/insertcurrency.php" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="currencyrate" name="currencyrate" placeholder="Enter Rate against UGX" required>
                    </div>
					
                  </div>
				    <div class="card-footer">
                    <button type="submit" id="currencysubmit" name="currencysubmit" class="btn btn-primary">Submit</button>
                  </div>
                  <!-- /.card-body -->
                </form>
              </div>
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sales7 = "SELECT * FROM `currency` order by ID Desc LIMIT 50";
                      ...
                      while ($row7 = mysqli_fetch_assoc($result7)) {
                        ...
                        $id = $row7['ID'];
                        echo  "<td>" . $counter3 . "</td>";
                        echo  "<td>" . $row7['CurrencyName'] . "</td>";
                        echo  "<td>" . $row7['CurrencyValue'] . "</td>";
                        echo "</tr>";
                        $counter3++;
                      }
                      ?>
