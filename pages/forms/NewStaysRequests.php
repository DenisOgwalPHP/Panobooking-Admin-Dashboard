...
<head>
  ...
  <title>PANOBOOKING | New Stays Requests</title>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
				...
				<li class="nav-item">
                  ...
                  <li class='nav-item'>
                  <a href='NewStaysRequests.php' class='nav-link active'>
                  <i class='far fa-circle nav-icon'></i>
                  <p>Stays</p>
                  </a>
                  </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>New Stays Request</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../DashBoard.php">Home</a></li>
                <li class="breadcrumb-item active">New Stays Request List</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card" style='overflow:auto'>
                <div class="card-header">
                  <h3 class="card-title">New Stays Request List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                        ...
                        $sales7 = "SELECT * FROM `cart` where Status='New' and BookingType='Stays' order by IDs Desc";
						 ...
						 echo "<div class='modal-dialog'>";
						   echo "<div class='modal-content bg-success'>";
							 echo "<div class='modal-header'>";
							   ...
							   echo "</button>";
							 echo "</div>";
							 echo "<form action='NewStaysRequests.php' method='post'>";
                    ...
                    if (isset($_GET['changestatus'])) {
                      ...
                      if ($result11) {
                        ...
                        echo 'window.location.href="NewStaysRequests.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
