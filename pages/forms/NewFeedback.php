...
<head>
  ...
  <title>PANOBOOKING | New Client Feedback</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
				...
				<li class="nav-item">
                   <a href='NewFeedback.php' class='nav-link active'>
                  <i class="far fa-circle nav-icon"></i>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">New Feedback List</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card" style='overflow:auto'>
                <div class="card-header">
                  <h3 class="card-title">New Feedback List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                        ...
                        $sales7 = "SELECT * FROM `clientfeedback` where Status='New' order by FeedBackID Desc";
                        ...
                        while ($row7 = mysqli_fetch_assoc($result7)) {
                          ...
                          $id = $row7['FeedBackID'];
                          echo  "<td>" . $counter3 . "</td>";
                          echo  "<td style='overflow-x:scroll;'>" . $row7['ClientName'] . "</td>";
                          echo  "<td style='overflow-x:scroll;'>" . $row7['ClientEmail'] . "</td>";
						   echo  "<td style='overflow-x:scroll;'>" . $row7['ClientJob'] . "</td>";
						   echo  "<td style='overflow-x:scroll;'>" . $row7['ClientCompany'] . "</td>";
                          echo  "<td style='overflow-y:scroll !important;'>" . $row7['FeedBack'] . "</td>";
                          echo  "<td style='overflow-x:scroll;'>" . $row7['created_at'] . "</td>";
						  if($row7['Approved']=="Not Approved"){
							 echo  "<td><form method='get' action='NewFeedback.php'><button type='submit' name='changeapproval'  value='" . $id . "' class='btn btn-block btn-danger'>Approve</button></form></td>";  
						  }else{
							 echo  "<td style='overflow-x:scroll;'>" . $row7['Approved'] . "</td>";  
						  }
						  if($row7['Status']=="New"){
							 echo  "<td><form method='get' action='NewFeedback.php'><button type='submit' name='changestatus'  value='" . $id . "' class='btn btn-block btn-danger'>New</button></form></td>";  
						  }else{
                    ...
                    if (isset($_GET['changestatus'])) {
					  ...
					  $sales11 = "UPDATE  clientfeedback SET Status='Opened'  WHERE FeedBackID='$id'";
                      $result11 = mysqli_query($link, $sales11);
                      if ($result11) {
                        echo '<script type="application/javascript">';
                        echo 'alert("Status Updated");';
                        echo 'window.location.href="NewFeedback.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
                     ...
                     if (isset($_GET['changeapproval'])) {
					  ...
					  $sales11 = "UPDATE  clientfeedback SET Approved='Approved'  WHERE FeedBackID='$id'";
                      $result11 = mysqli_query($link, $sales11);
                      if ($result11) {
                        echo '<script type="application/javascript">';
                        echo 'alert("Status Updated");';
