...
<head>
  ...
  <title>PANOBOOKING | New Ambulances</title>
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item  active">
                  <a href="NewAmbulanceRegistration.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Ambulance</p>
                  </a>
                </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>New Self Registered Ambulances</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../DashBoard.php">Home</a></li>
                <li class="breadcrumb-item active">New Self Registered Ambulances List</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card" style='overflow:auto'>
                <div class="card-header">
                  <h3 class="card-title">New Self Registered Ambulances List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sales7 = "SELECT * FROM `ambulances` WHERE Approved='Not Approved' order by IDs Desc";
                      ...
                      while ($row7 = mysqli_fetch_assoc($result7)) {
						...
						echo  "<td><form method='get' action='NewAmbulanceRegistration.php'><button type='submit' name='approve'  value='" . $id . "' class='btn btn-block btn-warning'>Approve</button></form></td>";
					  }else{
						  echo  "<td style='overflow-x:scroll;'>" . $row7['Approved'] . "</td>";  
					  }
                        echo  "<td><form method='get' action='NewAmbulanceRegistration.php'><button type='submit' name='delete'  value='" . $id . "' class='btn btn-block btn-danger'>Delete</button></form></td>";
                        echo " </tr>";
                        $counter3++;
                      }
                      ?>
                    ...
                    if (isset($_GET['approve'])) {
                      ...
                      if ($result) {
                        ...
                        echo 'window.location.href="NewAmbulanceRegistration.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
