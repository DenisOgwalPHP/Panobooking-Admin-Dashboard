...
<head>
  ...
  <title>PANOBOOKING |  Add Tourism Sites</title>
...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
				...
				<li class="nav-item">
				 ...
				 <li class="nav-item">
                  <a href="AddTourismSite.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Tourim Site Form</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../DashBoard.php">Home</a></li>
                <li class="breadcrumb-item active">Tourim Site Form</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Add Tourim Site</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="../formsinsert/inserttourismsite.php" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tourism Site Name</label>
                      <input class="form-control" type="text" id="sitename" name="sitename" placeholder="Enter Tourism Site Name" required>
                    </div>
					<div class="form-group">
                      <label for="exampleInputEmail1">Tourism Site City</label>
                      <input class="form-control" type="text" id="city" name="city" placeholder="Enter Tourism Site City" required>
                    </div>
					<div class="form-group">
                      <label for="exampleInputEmail1">Tourism Site Country</label>
                      <input class="form-control" type="text" id="country" name="country" placeholder="Enter Tourism Site Country" required>
                    </div>
					 <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="articledetails" name="articledetails" placeholder="Enter Tourism Site Details..." required></textarea>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputFile">Site Main Image</label>
            ...
            <div class="col-md-6">
              ...
              <div class="card card-danger">
                <div class="card-header">
                  <h3 class="card-title">Tourism Sites</h3>
                </div>
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sales7 = "SELECT * FROM `tourismsites` order by ID Desc LIMIT 20";
                    ...
                    <tfoot>
                      <tr>
                        <th>X</th>
						<th><button type="button"  class="btn btn-danger" data-toggle="modal" data-target="#modal-danger">Edit Site Details</button></th>
						<th><button type="button"  class="btn btn-primary" data-toggle="modal" data-target="#modal-primary">Add Image</button></th>
						<th>X</th>
					  </tr>
                    </tfoot>
                  </table>
    ...
    <!-- /.content-wrapper -->
      ...
      <div class="modal fade" id="modal-danger">
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
           ...
           <form action="AddTourismSite.php" method="post">
		    <div class="modal-body">
        <p>&nbsp;</p>
        <select class="form-control" id="tourismarticle" name="tourismarticle" required>
          <?php require_once('../../connect/connect.php');
          $sales9 = "SELECT Distinct SiteName FROM `tourismsites`";
          $result9 = mysqli_query($link, $sales9);
          echo '<option value="Other">Select Tourism Site Name</option>';
          while ($row9 = mysqli_fetch_assoc($result9)) {
            echo '<option value="' . $row9['SiteName'] . '">' . $row9['SiteName'] . '</option>';
          }  ?>
        </select>
        <p>&nbsp;</p>
          ...
          <div class="custom-file">
            <select class="form-control" id="taxioption" name="taxioption" required>
              <option value="">--Select what you want to change--</option>
			   <option value="Search Key Words">Search Key Words</option>
        ...
        <p>&nbsp;</p>
        <Button type="submit" name="updatedetails" id="updatedetails" value="siteupdate" class="btn btn-block btn-success">UPDATE</Button>
      </form>
	  </div>
	  ...
	  <?php
		  if (isset($_REQUEST['updatedetails'])=="siteupdate") {
			$realvalue = $_POST['realvalue'];
			$productnames = $_POST['tourismarticle'];
			$taxioption = $_POST['taxioption'];
			require_once('../../connect/connect.php');
			if($taxioption=="Short Description"){
			$query = "UPDATE `tourismsites` SET ShortDescription='" . $realvalue . "' WHERE SiteName='" . $productnames . "'";
		  }else if($taxioption=="Description"){
			$query = "UPDATE `tourismsites` SET Description='" . $realvalue . "' WHERE SiteName='" . $productnames . "'";  
		  }
		  else if($taxioption=="City"){
			$query = "UPDATE `tourismsites` SET City='" . $realvalue . "' WHERE SiteName='" . $productnames . "'";  
		  }else if($taxioption=="Country"){
			$query = "UPDATE `tourismsites` SET Country='" . $realvalue . "' WHERE SiteName='" . $productnames . "'";  
		  }else if($taxioption=="Search Key Words"){
			$query = "UPDATE `tourismsites` SET SearchKeyWords='" . $realvalue . "' WHERE SiteName='" . $productnames . "'";  
		  }
      ...
      <div class="modal fade" id="modal-primary">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
			...
			<form action="AddTourismSite.php" method="post" enctype="multipart/form-data">
            <div class="modal-body">
			<select class="form-control" id="Place" name="Place" required>
                        <?php require_once('../../connect/connect.php');
						$sales9 ="SELECT Distinct SiteName FROM `tourismsites`";
						$result9=mysqli_query($link,$sales9);
						echo '<option value="">Select Tourism Site</option>';
						while($row9=mysqli_fetch_assoc($result9)){
						echo '<option value="'.$row9['SiteName'].'">'.$row9['SiteName'].'</option>';
						}	?>			
             </select>
			...
			<div class="custom-file">
			 <input type="file" class="custom-file-input" id="Filename" name="Filename">
			  <label class="custom-file-label" for="exampleInputFile">Image(Dimensions should be 850x850 pixels)</label>
			</div>
			 </div>
			 <p>&nbsp;</p>
			 <div class="input-group">
			...
			<button type="submit" name="saveplaceimages" value="saveima" class="btn btn-success">Save Image</button>
			   </div>
            </div>
			</form>
            <div class="modal-footer justify-content-between">
		  ...
		  if (isset($_REQUEST['updateplaceimages'])=="updateima") {
			...
			$target = '../../../AndroidFiles/TourismSiteThumbnail/';
			$fileTarget = $target . $newfilename;
			$tempFileName = $_FILES["Filename"]["tmp_name"];
			$result = move_uploaded_file($tempFileName, $fileTarget);
			echo '<script type="application/javascript">';
			echo'alert("Update of  Image Done");';
			echo'window.location.href="AddTourismSite.php";';
			echo '</script>';
		  }
		   ...
		   if (isset($_REQUEST['saveplaceimages'] )=="saveima") {
			$place = $_POST['Place'];
			require_once('../../connect/connect.php');
			$sql1="SELECT PhotoUri FROM tourismsites where SiteName like '".$place."%'";
			$result1=mysqli_query($link,$sql1);
			if (mysqli_num_rows($result1) == 1)
			{
			$row = mysqli_fetch_array($result1);
			$imageurl=$row['PhotoUri']+1;
			$sql="UPDATE tourismsites SET PhotoUri='$imageurl' where SiteName like '".$place."%'";
