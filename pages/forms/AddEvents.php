...
<head>
  ...
  <title>PANOBOOKING |  Add Events</title>
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
				...
				<li class="nav-item">
				 ...
				 <li class="nav-item">
                  <a href="AddEvents.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Events</p>
                  </a>
                </li>
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Add Events Site</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="../formsinsert/insertevent.php" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Event Name</label>
                      <input class="form-control" type="text" id="sitename" name="sitename" placeholder="Enter Event Name" required>
                    </div>
					<div class="form-group">
                      <label for="exampleInputEmail1">Event City</label>
                      <input class="form-control" type="text" id="city" name="city" placeholder="Enter City Where Event will Happen" required>
                    </div>
					<div class="form-group">
                      <label for="exampleInputEmail1">Event Country</label>
                      <input class="form-control" type="text" id="country" name="country" placeholder="Enter Country Where Event will Happen" required>
                    </div>
					 <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="articledetails" name="articledetails" placeholder="Enter Event Details..." required></textarea>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputFile">Event Main Image</label>
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sales7 = "SELECT * FROM `events` order by ID Desc LIMIT 20";
                    ...
                    <tfoot>
                      <tr>
                        <th>X</th>
						<th><button type="button"  class="btn btn-danger" data-toggle="modal" data-target="#modal-danger">Edit Event Details</button></th>
    ...
    <!-- /.content-wrapper -->
      ...
      <div class="modal fade" id="modal-danger">
        ...
        <select class="form-control" id="tourismarticle" name="tourismarticle" required>
          ...
          $sales9 = "SELECT Distinct EventName FROM `events`";
          $result9 = mysqli_query($link, $sales9);
          echo '<option value="Other">Select Event Name</option>';
          while ($row9 = mysqli_fetch_assoc($result9)) {
            echo '<option value="' . $row9['EventName'] . '">' . $row9['EventName'] . '</option>';
          }  ?>
        </select>
        <p>&nbsp;</p>
	  ...
	  <?php
		  if (isset($_REQUEST['updatedetails'])=="siteupdate") {
			...
			$query = "UPDATE `events` SET ShortDescription='" . $realvalue . "' WHERE EventName='" . $productnames . "'";
		  }else if($taxioption=="Description"){
			$query = "UPDATE `events` SET Description='" . $realvalue . "' WHERE EventName='" . $productnames . "'";  
		  }
		  else if($taxioption=="City"){
			$query = "UPDATE `events` SET City='" . $realvalue . "' WHERE EventName='" . $productnames . "'";  
		  }else if($taxioption=="Country"){
			$query = "UPDATE `events` SET Country='" . $realvalue . "' WHERE EventName='" . $productnames . "'";  
		  }else if($taxioption=="Search Key Words"){
			$query = "UPDATE `events` SET SearchKeyWords='" . $realvalue . "' WHERE EventName='" . $productnames . "'";  
		  }
		  else if($taxioption=="Start Date"){
			$query = "UPDATE `events` SET StartDate='" . $realvalue . "' WHERE EventName='" . $productnames . "'";  
		  }
		  else if($taxioption=="End Date"){
			$query = "UPDATE `events` SET EndDate='" . $realvalue . "' WHERE EventName='" . $productnames . "'";  
		  }
      ...
      <div class="modal fade" id="modal-primary">
        <div class="modal-dialog">
		  ...
		  if (isset($_REQUEST['updateplaceimages'])=="updateima") {
			...
			$target = '../../../AndroidFiles/EventsThumbnail/';
		   ...
		   if (isset($_REQUEST['saveplaceimages'] )=="saveima") {
			$place = $_POST['Place'];
			require_once('../../connect/connect.php');
			$sql1="SELECT PhotoUri FROM events where EventName like '".$place."%'";
			$result1=mysqli_query($link,$sql1);
			if (mysqli_num_rows($result1) == 1)
			{
			$row = mysqli_fetch_array($result1);
			$imageurl=$row['PhotoUri']+1;
			$sql="UPDATE events SET PhotoUri='$imageurl' where EventName like '".$place."%'";
