...
<head>
  ...
  <title>PANOBOOKING | New Airport Taxis</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
				...
				<li class="nav-item">
                  <a href="NewAirportTaxiRequests.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Airport Taxis</p>
                  </a>
                </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>New Airport Taxis Request</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../DashBoard.php">Home</a></li>
                <li class="breadcrumb-item active">New Airport Taxis Request List</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              ...
              <div class="card" style='overflow:auto'>
                <div class="card-header">
                  <h3 class="card-title">New Airport Taxis Request List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                        ...
                        $sales7 = "SELECT * FROM `cart` where Status='New' and BookingType='Airport Taxi' order by IDs Desc";
						 ...
						 echo "<div class='modal-dialog'>";
						   echo "<div class='modal-content bg-success'>";
							 echo "<div class='modal-header'>";
							   ...
							   echo "</button>";
							 echo "</div>";
							 echo "<form action='NewAirportTaxiRequests.php' method='post'>";
                    ...
                    if (isset($_GET['changestatus'])) {
                      ...
                      if ($result11) {
                        ...
                        echo 'window.location.href="NewAirportTaxiRequests.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
			...
			$to = $useremail;
				...
				$messages = 'Your Booking has been confirmed by '.$facilityname.' for a reason: '.$reason.'. Panobooking may further contact you. Please it will just be Follow up.';
			...
			$message .='<div style="text-align:center;background-color:#3383ff;width:100%;padding-top:10px;padding-bottom:10px;border-radius: 30px 30px 0px 0px;"><h1 style="text-align: center;padding:0px;font-size:20px;font-weight:500;color:white;">Response From Panobooking</h1></div>';
			$message .='<p style="font-size:15px;padding:10px; margin:10px;text-align:justify">'.$messages.'</p>';
			$message .= '</body></html>';
		  ...
		  if (isset($_REQUEST['rejectbooking'])) {
			...
			$messages = 'Your Booking has been Rejected by '.$facilityname.' for a reason: '.$reason.'. Panobooking may further contact you. Please it will just be Follow up. But please feel free to place another booking.';
			$headers = "MIME-Version: 1.0" . "\r\n";
			$headers .= "Content-type: text/html; charset=iso-8859-1" . "\r\n";
			$headers = 'From:'.$emails. "\r\n" .'Reply-To: '.$emails . "\r\n" .'X-Mailer: PHP/' . phpversion();
			$message ='<html><body>';
