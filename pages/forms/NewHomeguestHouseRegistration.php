...
<head>
  ...
  <title>PANOBOOKING | New Home Guest House Self Registration</title>
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  ...
                  <li class='nav-item'>
                  <a href='NewHomeguestHouseRegistration.php' class='nav-link active'>
                  <i class='far fa-circle nav-icon'></i>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>New Self Registered Home Guest Houses</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../DashBoard.php">Home</a></li>
                <li class="breadcrumb-item active">New Self Registered Home Guest Houses List</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card" style='overflow:auto'>
                <div class="card-header">
                  <h3 class="card-title">New Self Registered Home Guest Houses List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sales7 = "SELECT * FROM `homeguesthouses` WHERE Approved='Not Approved' order by IDs Desc";
                      ...
                      while ($row7 = mysqli_fetch_assoc($result7)) {
                        ...
                        echo  "<td style='overflow-x:scroll;'>" . $row7['GuestHouseName'] . "</td>";
                    ...
                    <?php
                     if (isset($_GET['approve'])) {
                      $id = $_GET['approve'];
                      $sales7 = "UPDATE homeguesthouses SET Approved='Approved' WHERE IDs='" . $id . "'";
                      $result = mysqli_query($link, $sales7);
                      if ($result) {
                        echo '<script type="application/javascript">';
                        echo 'alert("Home Guest House Record successfully Approved");';
                        echo 'window.location.href="NewHomeguestHouseRegistration.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
                        echo 'alert("Home Guest House Approval Failed");';
                        echo 'window.location.href="NewHomeguestHouseRegistration.php";';
                        echo '</script>';
                      }
                    }
                    if (isset($_GET['delete'])) {
                      $id = $_GET['delete'];
                      $sales7 = "DELETE  FROM homeguesthouses WHERE IDs='" . $id . "'";
                      $result = mysqli_query($link, $sales7);
                      if ($result) {
                        echo '<script type="application/javascript">';
                        echo 'alert("Home Guest House Record successfully Deleted");';
                        echo 'window.location.href="NewHomeguestHouseRegistration.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
                        echo 'alert("Home Guest House Record Delete Failed");';
                        echo 'window.location.href="NewHomeguestHouseRegistration.php";';
                        echo '</script>';
                      }
                    }
