...
<head>
  ...
  <title>PANOBOOKING | New Car Rental</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="NewCarRequests.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Car Rentals</p>
                  </a>
                </li>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">New Car Rental Request List</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card" style='overflow:auto'>
                <div class="card-header">
                  <h3 class="card-title">New Car Rental Request List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                        ...
                        $sales7 = "SELECT * FROM `cart` where Status='New' and BookingType='Car Rental' order by IDs Desc";
						 ...
						 echo "<div class='modal-dialog'>";
						   echo "<div class='modal-content bg-success'>";
							 echo "<div class='modal-header'>";
							   ...
							   echo "</button>";
							 echo "</div>";
							 echo "<form action='NewCarRequests.php' method='post'>";
                    ...
                    if (isset($_GET['changestatus'])) {
					  ...
					  $sales11 = "UPDATE  Status SET Status='Opened'  WHERE ID='$id'";
                      $result11 = mysqli_query($link, $sales11);
                      if ($result11) {
                        echo '<script type="application/javascript">';
                        echo 'alert("Status Updated");';
                        echo 'window.location.href="NewCarRequests.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
