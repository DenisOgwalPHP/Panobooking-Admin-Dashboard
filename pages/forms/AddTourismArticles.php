...
<head>
  ...
  <title>PANOBOOKING | Tourism Articles</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="AddTourismArticles.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Tourism Articles Form</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../DashBoard.php">Home</a></li>
                <li class="breadcrumb-item active">Tourism Articles Form</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Add Tourism Article</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="../formsinsert/inserttourismarticles.php" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Article Title</label>
                      <input class="form-control" type="text" id="articletitle" name="articletitle" placeholder="Enter article Title">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Details</label>
                      <textarea class="form-control" rows="3" id="articledetails" name="articledetails" placeholder="Enter Article Details..."></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleInputFile">Article Thumbnail/Cover</label>
                      <div class="input-group">
                        <div class="custom-file">
                  ...
                  <div class="card-footer">
                    <button type="submit" id="tourismarticlesubmit" name="tourismarticlesubmit" class="btn btn-primary">Submit</button>
                  </div>
                </form>
              </div>
              <!-- /.card -->
            ...
            <div class="col-md-6">
              ...
              <div class="card card-danger">
                <div class="card-header">
                  <h3 class="card-title">Tourism Articles</h3>
                </div>
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $sales7 = "SELECT * FROM `tourismarticles` order by IDs Desc LIMIT 30";
                      ...
                      while ($row7 = mysqli_fetch_assoc($result7)) {
                        ...
                        $id = $row7['IDs'];
                        echo  "<td>" . $counter3 . "</td>";
                        echo  "<td>" . $row7['ArticleTitle'] . "</td>";
                        echo  "<td>" . $row7['PostedAt'] . "</td>";
                    ...
                    <tfoot>
                      <tr>
                        <th>X</th>
                        <th> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-primary">Add Tourism Article Image</button></th>
						<th><button type="button"  class="btn btn-danger" data-toggle="modal" data-target="#modal-danger">Edit Article Details</button></th>
						<th> <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-warning">Reupload Attachment</button></th>
                      </tr>
                    </tfoot>
                  </table>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-warning">
            <div class="modal-header">
              <h4 class="modal-title">ReUpload Article Attachment</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
           <form action="AddTourismArticles.php" method="post" enctype="multipart/form-data">
            <div class="modal-body">
			<select class="form-control" id="Place" name="Place" required>
                        <?php require_once('../../connect/connect.php');
						$sales9 ="SELECT Distinct ArticleTitle FROM `tourismarticles`";
						$result9=mysqli_query($link,$sales9);
						echo '<option value="">Select Article</option>';
						while($row9=mysqli_fetch_assoc($result9)){
						echo '<option value="'.$row9['ArticleTitle'].'">'.$row9['ArticleTitle'].'</option>';
						}	?>			
             </select>
             <p>&nbsp;</p>			
			<div class="input-group">
			<div class="custom-file">
			 <input type="file" class="custom-file-input" id="Filenames" name="Filenames">
			  <label class="custom-file-label" for="exampleInputFile">Article Attachment</label>
			</div>
			 <p>&nbsp;</p>			
		    </div>
			<div class="input-group">
			   <button type="submit" name="savearticle" value="Updatearticle" class="btn btn-danger">Save Attachment</button>
			   </div>
            </div>
			</form>
      ...
      <div class="modal fade" id="modal-danger">
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
           ...
           <form action="../formsinsert/updatearticledetails.php" method="post">
		    <div class="modal-body">
        <p>&nbsp;</p>
        <select class="form-control" id="tourismarticle" name="tourismarticle" required>
          ...
          $sales9 = "SELECT Distinct ArticleTitle FROM `tourismarticles`";
          $result9 = mysqli_query($link, $sales9);
          echo '<option value="Other">Select Article Name</option>';
          while ($row9 = mysqli_fetch_assoc($result9)) {
            echo '<option value="' . $row9['ArticleTitle'] . '">' . $row9['ArticleTitle'] . '</option>';
          }  ?>
        </select>
      ...
      <div class="modal fade" id="modal-primary">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
			...
			<div class="custom-file">
			 <input type="file" class="custom-file-input" id="Filename" name="Filename">
			  <label class="custom-file-label" for="exampleInputFile">Article Thumbnail(Dimensions should be 850x850 pixels)</label>
			</div>
			 <p>&nbsp;</p>			
		    </div>
			<div class="input-group">
		  ...
		  if (isset($_REQUEST['saveimage'])) {
			...
			$target = '../../../AndroidFiles/TourismArticleThumbNail/';
			$fileTarget = $target . $newfilename;
			$tempFileName = $_FILES["Filename"]["tmp_name"];
			$result = move_uploaded_file($tempFileName, $fileTarget);
			echo '<script type="application/javascript">';
			echo'alert("Upload of Tourism Article Thumbnail Done");';
			echo'window.location.href="AddTourismArticles.php";';
			echo '</script>';
		  }
		  ?>
