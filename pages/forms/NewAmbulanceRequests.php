...
<head>
  ...
  <title>PANOBOOKING | New Ambulance Requests</title>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="NewAmbulanceRequests.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Ambulance</p>
                  </a>
                </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>New Ambulance Call</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../../DashBoard.php">Home</a></li>
                <li class="breadcrumb-item active">New Ambulance Call List</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              ...
              <div class="card" style='overflow:auto'>
                <div class="card-header">
                  <h3 class="card-title">New Ambulance Call List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                        ...
                        $sales7 = "SELECT * FROM `cart` where Status='New' and BookingType='Ambulance' order by IDs Desc";
						 ...
						 echo "<div class='modal-dialog'>";
						   echo "<div class='modal-content bg-success'>";
							 echo "<div class='modal-header'>";
							   ...
							   echo "</button>";
							 echo "</div>";
							 echo "<form action='NewAmbulanceRequests.php' method='post'>";
                    ...
                    if (isset($_GET['changestatus'])) {
                      ...
                      if ($result11) {
                        ...
                        echo 'window.location.href="NewAmbulanceRequests.php";';
                        echo '</script>';
                      } else {
                        echo '<script type="application/javascript">';
			...
			$to = $useremail;
				...
				$messages = 'Your Call has been confirmed by '.$facilityname.' for a reason: '.$reason.'. Panobooking may further contact you. Please it will just be Follow up.';
		  ...
		  if (isset($_REQUEST['rejectbooking'])) {
			...
			$to = $useremail;
				...
				$messages= 'Your Call has been Rejected by '.$facilityname.' for a reason: '.$reason.'. Panobooking may further contact you. Please it will just be Follow up. But please feel free to place another Call.';
				$headers = "MIME-Version: 1.0" . "\r\n";
				$headers .= "Content-type: text/html; charset=iso-8859-1" . "\r\n";
				$headers = 'From:'.$emails. "\r\n" .'Reply-To: '.$emails . "\r\n" .'X-Mailer: PHP/' . phpversion();
				$message ='<html><body>';
