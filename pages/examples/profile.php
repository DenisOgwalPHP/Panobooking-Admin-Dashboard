...
<head>
  ...
  <title>PANOBOOKING | Profile</title>
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo $_SESSION['panobookingadminuser'];?></h3>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <strong><i class="fas fa-book mr-1"></i>Names</strong>

                <p class="text-muted">
                <?php
                    require_once('../../connect/connect.php');
                    $emails = $_SESSION['panobookingadminemail'];
                    $sales6 = "SELECT FullNames FROM `staffregistration` WHERE Email='" . $emails . "' ";
